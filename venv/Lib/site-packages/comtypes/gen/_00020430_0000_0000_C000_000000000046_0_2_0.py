...
__all__ = [ 'IPicture', 'Picture', 'OLE_XSIZE_CONTAINER', 'VgaColor',
           'LoadPictureConstants', 'FONTSTRIKETHROUGH',
           'OLE_YSIZE_CONTAINER', 'Font', 'FONTITALIC',
           'OLE_XPOS_HIMETRIC', 'OLE_TRISTATE', 'IFontEventsDisp',
           'StdPicture', 'OLE_YSIZE_HIMETRIC', 'OLE_CANCELBOOL',
           'OLE_COLOR', 'FontEvents', 'OLE_YSIZE_PIXELS',
           'OLE_YPOS_CONTAINER', 'OLE_XSIZE_PIXELS',
           'OLE_XSIZE_HIMETRIC', 'Default', 'Checked', 'IFont',
           'OLE_OPTEXCLUSIVE', 'StdFont', 'FONTUNDERSCORE',
           'OLE_XPOS_PIXELS', 'OLE_XPOS_CONTAINER', 'FONTSIZE',
           'Color', 'OLE_ENABLEDEFAULTBOOL', 'OLE_YPOS_HIMETRIC',
           'Gray', 'IFontDisp', 'OLE_YPOS_PIXELS', 'IPictureDisp',
           'Unchecked', 'FONTNAME', 'FONTBOLD', 'OLE_HANDLE',
           'Monochrome']
from comtypes import _check_version; _check_version('1.1.9', 1552970625.570791)
